...
class TraceROISelectPanel(wx.Panel):
    def __init__(self, parent, trace_page, winid=-1):
        ...
        hsizer = wx.BoxSizer(wx.HORIZONTAL)
        # self.roi_button = wx.Button(self, -1, 'Set ROI')
        # hsizer.Add(self.roi_button, 0, wx.ALL, 2)
        # self.roi_button.Bind(wx.EVT_BUTTON, self.OnSetROI)
    ...
    # def OnSetROI(self, wx_event=None):
    #     print('here trace page')
    #     self.trace_page.assign_do()
    #     self.clear_button.Enable()
    #     self.relclear_button.Enable()
